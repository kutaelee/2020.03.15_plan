$(document).ready(()=>{
	...
	function calculateFaceMove(e) {
	    ...
	    if(carPos == null || carPos == 0) {
	        // if browser doesn't support 'selectionEnd' property on
			// input[type="email"], use 'value.length' property instead
	...
	function initLoginForm() {
	    ...
	    IDLabel.addEventListener('click', onIDLabelClick);
